...
import { User as UserIcon, Mail, Lock, UserPlus, UtensilsCrossed } from 'lucide-react';
...
const Register = () => {
    ...
    const submitHandler = async (e) => {
        ...
        try {
            ...
            const msg = err.response?.data?.message || err.message || err.data?.message || 'Registration Failed';
            setErrorMsg(msg);
        }
    };
            ...
            <div className="relative w-full max-w-md">
                ...
                <div className="relative bg-white dark:bg-slate-800 rounded-2xl shadow-2xl overflow-hidden">
                    <div className="bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950 p-8 text-center">
                        ...
                        <p className="text-gray-300 dark:text-gray-400 mt-2">Join our cooking community</p>
                    </div>
                    ...
                    <div className="p-8">
                        ...
                        <form onSubmit={submitHandler} className="space-y-4">
                            ...
                            <button
                                type="submit"
                                className="w-full flex justify-center items-center mt-2 py-3.5 px-4 bg-gradient-to-r from-cyan-500 to-blue-500 hover:from-cyan-600 hover:to-blue-600 text-white font-bold rounded-xl transition-all duration-300 shadow-lg hover:shadow-cyan-500/25"
                            >
                        ...
                        <div className="mt-8 text-center text-gray-600 dark:text-gray-400">
                            ...
                            <Link to="/login" className="font-bold text-cyan-600 dark:text-cyan-400 hover:text-cyan-700 dark:hover:text-cyan-300 transition">
                                Log in
                            </Link>
                        </div>
                    </div>
